...
__global__ void forward_kernel(float *y, const float *x, const float *k, const int B, const int M, const int C, const int H, const int W, const int K)
{
    ...
    */
    ...
    h = blockIdx.z /(H_Grid)  * BLOCK_WIDTH + threadIdx.y; //idx of height of output tile
    w = blockIdx.z % (W_Grid) * BLOCK_WIDTH + threadIdx.x; //idx of width of output tile
    ...
    #pragma unroll
    for (c = 0; c < C; c++){ //num of input feature maps
        #pragma unroll
